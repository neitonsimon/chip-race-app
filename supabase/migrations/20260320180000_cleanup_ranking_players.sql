-- migration: 20260320_cleanup_ranking_players.sql
-- Objetivo: Remover a tabela ociosa ranking_players e atualizar a função de fusão de contas.

-- 1. Removemos a tabela ranking_players
DROP TABLE IF EXISTS public.ranking_players CASCADE;

-- 2. Atualizamos a função merge_player_accounts para remover o bloco que tentava fundir dados nela
...
BEGIN
  ...
  -- ==========================================
  -- [BLOCO REMOVIDO: ranking_players não é mais utilizada]
  ...
  RETURN json_build_object('success', true, 'message', 'Contas mescladas com sucesso (Limpeza de Ranking concluída).');
