                    ...
                    <div className="space-y-10 font-light leading-relaxed text-gray-300 text-justify">
                        ...
                        <section>
                            ...
                            <div className="space-y-3">
                                ...
                                <p>
                                    <strong>3.2. Valor Base:</strong> Para o garantido inicial do THE CHOSEN 2026, o custo base de Rebuy e Add-on é fixado em <strong>R$ 200,00</strong>.
                                </p>
                                <p>
                                    <strong>3.3. Regra de Ajuste Progressivo:</strong> Para manter a proporcionalidade da premiação, o valor do Rebuy e Add-on sofrerá um acréscimo de <strong>R$ 5,00</strong> para cada <strong>R$ 1.000,00</strong> adicionados ao prêmio garantido total acima do valor inicial.
                                </p>
