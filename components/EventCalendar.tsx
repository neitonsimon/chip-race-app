...
const PARALLEL_PRODUCTS = [
    ...
    { id: 'bet', label: 'Bet / Lucky Loser', style: 'text-green-400 border-green-500/30 bg-green-500/10' },
            ...
            {viewEvent && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-md">
                    ...
                    >
                        ...
                        {/* 1. Header Section */}
                        <div className="pt-8 pb-4 px-6 text-center shrink-0 flex flex-col items-center">
                            {/* Date Pill */}
                            <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full border border-white/10 bg-white/5 backdrop-blur-md mb-4 shadow-lg">
                            ...
                            {/* Title */}
                            <h2 className="text-4xl md:text-5xl font-display font-black text-white uppercase leading-[0.9] text-glow drop-shadow-xl mb-6 break-words w-full max-w-[90%]">
                                {viewEvent.title}
                            </h2>
                        ...
                        <div className="flex-1 flex flex-col px-6 pb-4 overflow-hidden gap-4">
                            ...
                            <div className="flex flex-col gap-2 min-h-0">
                                <h4 className="text-[10px] font-bold text-gray-500 uppercase tracking-widest pl-1 shrink-0">Estrutura de Fichas</h4>
                        ...
                        {/* 3. Footer */}
                        <div className="bg-[#02010a] px-6 py-4 border-t border-white/5 flex justify-between items-center shrink-0">
                            <div className="flex items-center gap-2">
                                <div className="w-5 h-5 bg-gradient-to-br from-primary to-accent rounded flex items-center justify-center text-white text-[8px] shadow-neon-pink">
                                    <span className="material-icons-outlined text-xs">token</span>
                                </div>
                                <span className="font-display font-black text-white text-xs tracking-tighter">CHIP<span className="text-primary">RACE</span></span>
                            </div>
                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-md">
                    ...
                    >
                        ...
                        <div className="pt-8 pb-2 px-6 text-center shrink-0 flex flex-col items-center">
                            <div className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-1">{viewClosedEvent.date.split('-').reverse().join('/')}</div>
                            <h3 className="text-xl md:text-2xl font-bold text-white mb-6 uppercase tracking-wider">{viewClosedEvent.title}</h3>
                                    ...
                                    <div className="flex flex-col items-center mb-6">
                                        ...
                                        <div className="relative mb-6">
                                            ...
                                            <img
                                                ...
                                                alt="Campeão"
                                                className="w-32 h-32 rounded-full border-4 border-yellow-400 shadow-[0_0_30px_rgba(250,204,21,0.5)] object-cover relative z-10"
                                            />
                                            <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 bg-yellow-400 text-black font-black text-xs px-3 py-1 rounded-full shadow-lg z-20 border-2 border-black">
                                                CAMPEÃO
                                            </div>
                                        </div>
                        ...
                        {/* 4. Footer */}
                        <div className="bg-[#02010a] px-6 py-3 border-t border-white/5 flex justify-between items-center shrink-0">
                            <div className="flex items-center gap-2">
                                <div className="w-4 h-4 bg-gradient-to-br from-primary to-accent rounded flex items-center justify-center text-white text-[8px] shadow-neon-pink">
                                    <span className="material-icons-outlined text-[10px]">token</span>
                                </div>
                                <span className="font-display font-black text-white text-[10px] tracking-tighter">CHIP<span className="text-primary">RACE</span></span>
                            </div>
                            <div className="text-[8px] text-gray-600 uppercase tracking-[0.2em] font-bold">
                                Resultados Oficiais
                            </div>
