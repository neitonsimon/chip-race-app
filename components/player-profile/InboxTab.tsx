                ...
                {filtered.length === 0 ? (
                    ...
                    filtered.map(msg => (
                        <div
                            ...
                            className={`p-4 md:p-6 rounded-2xl md:rounded-3xl border transition-all cursor-pointer group flex gap-4 md:gap-6 items-center ${msg.read ? 'bg-black/20 border-white/5 opacity-80' : 'bg-surface-dark border-primary/30 shadow-[0_0_30px_rgba(217,0,255,0.05)] hover:border-primary/60'}`}
                        >
