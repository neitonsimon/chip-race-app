...
export default function App() {
    ...
    const showFooter = ['the-chosen-details', 'calendar', 'ranking', 'vip', 'recarga', 'the-chosen-regulations', 'terms', 'privacy', 'rules', 'responsible-gaming', 'copa-mundo-poker', 'jackpot', 'cash-league', 'cvth2'].includes(currentView) || currentView.startsWith('cash-league-individual-');
